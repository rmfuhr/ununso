...
$(document).ready(function() {
    ...
    function getJsonCustom() {
        ...
        function(feeds) {
                ...
                if (((showretweets == true) || ((isaretweet == false) && (showretweets == false))) && ((showdirecttweets == true) || ((showdirecttweets == false) && (isdirect == false)))) {
                    if ((feeds[i].text.length > 1) && (displayCounter <= displaylimit)) {
                        ...
                        if (showtweetactions == true) {
                            feedHTML += '<ul class="twitter-actions list-inline text-right"><li><a href="https://twitter.com/intent/tweet?in_reply_to=' + tweetid + '"><i class="fa fa-reply"></i> Reply</a></li><li><a href="https://twitter.com/intent/retweet?tweet_id=' + tweetid + '"><i class="fa fa-retweet"></i> Retweet</a></li><li><a href="https://twitter.com/intent/favorite?tweet_id=' + tweetid + '"><i class="fa fa-star"></i> Favourite</a></li></ul>';
                        }
            ...
            $('#twitter-feeds').html(feedHTML).owlCarousel({
                mouseDrag: false,
                items: 1,
                smartSpeed: 900
            });
